...
const IsoWidgetsWrapper = dynamic(() => import('./widgets-wrapper'));
const IsoWidgetBox = dynamic(() => import('./widget-box'));
const CardWidget = dynamic(() => import('./card/card-widgets'));
const ProgressWidget = dynamic(() => import('./progress/progress-widget'));
const SingleProgressWidget = dynamic(() =>
  import('./progress/progress-single')
);
const ReportsWidget = dynamic(() => import('./report/report-widget'));
const StickerWidget = dynamic(() => import('./sticker/sticker-widget'));
const SaleWidget = dynamic(() => import('./sale/sale-widget'));
const VCardWidget = dynamic(() => import('./vCard/vCard-widget'));
const SocialWidget = dynamic(() => import('./social-widget/social-widget'));
const SocialProfile = dynamic(() =>
  import('./social-widget/social-profile-icon')
);
...
import userpic from '../../static/image/user2.png';
...
export default class IsoWidgets extends Component {
  render() {
    ...
    const stackConfig = {
      ...
      width: process.browser && window.innerWidth < 450 ? 300 : 500,
    };
    return (
